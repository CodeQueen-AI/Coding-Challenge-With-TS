//Function Parameters and Return Values: Create a function that takes two numbers as parameters, adds them 
//together, and returns the result. Show how you can call this function and log the result.
